    ...
    <>
      <header className="flex overflow-x-auto flex-row border sticky top-0 z-50 bg-white  _nav px-2 sm:px-0">
        <div className="_header sm:flex ">
          <div
            className=" basis-1/6 sm:flex font-extrabold max-w-[150px] md:max-w-[178px] px-8  w-full cursor-pointer sm:hover:bg-gray-50 items-center justify-center border-r _border-light"
            onClick={homeHandler}
          >
            <span className="  md:text-[38px] text-blink tracking-tight">
              blink
            </span>
            <span className=" md:text-[38px] text-it tracking-tight">
              it
            </span>
          </div>

          <div className="w-fit basis-1/6 sm:w-[240px] xl:w-[320px] py-4 px-10  mr-9 sm:p-0 _header_loc flex items-center sm:justify-center cursor-pointer sm:hover:bg-gray-50">
            <LocationDetector />
          </div>

          <div className="flex-1 mt-1 basis-2/6 relative _header_search  ">
            <SearchBar />
          </div>
...
<span className="sm:hidden _text-default  sm:hover:bg-gray-50 ">
  <FaRegUser size={20} />
</span>
